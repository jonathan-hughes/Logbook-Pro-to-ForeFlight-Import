...
def AssembleTemplateData():
    ...
    with open(importFile, 'w', newline='') as f:
        ...
        logbookImport.writerow(['Text',      'Text',    'YYYY','Text','Text', 'Text',    'Text', 'Text',    'Text',      'Boolean','Boolean',        'Boolean'])
        logbookImport.writerow(['AircraftID','TypeCode','Year','Make','Model','Category','Class','GearType','EngineType','Complex','HighPerformance','Pressurized'])
